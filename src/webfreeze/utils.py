...
def save_html(soup: BeautifulSoup, file_path: str) -> None:
    """Save BeautifulSoup object to a file, preserving script/style contents."""
    # Use formatter=None to prevent BeautifulSoup from escaping characters inside <script> and <style>
    # such as & -> &amp; which can break CSS/JS logic.
